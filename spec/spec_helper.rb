# Originally from https://github.com/aws/aws-sdk-ruby/blob/master/aws-sdk-core/spec/spec_helper.rb

require "simplecov"
require "rspec"
require "webmock/rspec"
require_relative "../lib/aws_assume_role"
require_relative "../lib/aws_assume_role/core_ext/aws-sdk/credential_provider_chain"

SimpleCov.command_name("test:unit:aws_assume_role")
...
RSpec.configure do |config|
    config.before(:each) do
        ...
        AwsAssumeRole.shared_config.fresh
    end
end
